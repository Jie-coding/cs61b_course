...
public class IntListTest {
    ...
    @Test
    public void testreDcatenate() {
        IntList A = IntList.of(1, 5, 9);
        IntList B = IntList.of(2, 5, 8);
        IntList exp = IntList.of(1, 5, 9, 2, 5, 8);
        assertEquals(exp, IntList.recatenate(A, B));
        assertEquals(IntList.of(1, 5, 9), A);
    }
